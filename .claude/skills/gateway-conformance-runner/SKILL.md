...
allowed-tools: Bash(.claude/skills/gateway-conformance-runner/run-conformance.sh:*) Bash(./run-conformance.sh:*) Bash(kind:*) Bash(kubectl:*) Bash(docker:*) Bash(cargo:make) Bash(ls:*) Bash(docker:*) Bash(cd:*) Bash(direnv:*) Bash(make:conformance) Read
---
